...
class HysterisisController:
    def __init__(self, high, low, cooldown_period):
        self.high = high
        self.sensorV = high
        self.low = low
        ...
        self.dState = False
        self.cooldown_timer = int(cooldown_period)
...
# "D:\Programming\Projects\Design Realization\SheetDataCleaning[service_account]\credentials.json"
@app.route('/')
def home():
